...
import Certificate2 from "../assets/certificate/Jovin_Roshan_Full_Stack_Developer.pdf"
import Certificate2_Image from "../assets/certificate/Certificate2_image.png"
...
export default function About({ setActiveBtn }) {
    ...
    const ceritificateList = [
        {
            desc:"Fundamentals of Web Development Program - Feb 8, 2025",
            image: Certificate1_Image,
            pdf: Certificate1
        },
        {
            desc:"Full Stack MERN Development Bootcamp",
            image: Certificate2_Image,
            pdf: Certificate2
        }
    ]
    const skillList = [
            ...
            <motion.div
                ...
                <div>
                    ...
                    <div className="flex gap-10">
                        {
                        ceritificateList.map(({ desc,pdf, image }) => (
                            <div>
                                <p className="text-white text-xs mb-1 w-48">{desc}</p>
                                <div className="glow-border w-fit p-[2px] rounded-xl">
                                    <a href={pdf} target="_blank" rel="noopener noreferrer">
                                        <img className="rounded-lg w-36 block" src={image} alt="certificate_img" />
                                    </a>
                                </div>
                            </div>
                        ))
