...
export default function About({ setActiveBtn }) {
    ...
    return (
        <div style={{ fontFamily: '"Roboto", sans-serif' }} className="relative border-[3px] border-yellow-500 mx-3 md:mx-40 my-2 md:my-8 px-4 py-6 bg-slate-900 rounded-3xl md:px-20 md:py-5">
                ...
                <div className="mt-1 md:mt-2">
                    ...
                    <div className="mt-2 md:mt-3">
                        ...
                        <div className="flex flex-wrap gap-x-1 gap-y-2">
                            <p className="text-black bg-white px-1 py-1 rounded-full"><i className="fa-brands fa-react"></i> REACT</p>
                            <p className="text-black bg-white px-1 py-1 rounded-full"><i class="fa-brands fa-node"></i> Node JS</p>
                            <p className="text-black bg-white px-1 py-1 rounded-full"><i class="fa-brands fa-html5"></i> HTML</p>
                            <p className="text-black bg-white px-1 py-1 rounded-full"><i class="fa-brands fa-css3-alt"></i> CSS</p>
                            <p className="text-black bg-white px-1 py-1 rounded-full"><i class="fa-brands fa-js"></i> JAVASCRIPT</p>
                            <p className="text-black bg-white px-1 py-1 rounded-full"><span className="font-light">ES</span> EXPRESS JS</p>
                            <p className="text-black bg-white px-1 py-1 rounded-full"><i class="fa-brands fa-envira"></i> MongoDB</p>
                            <p className="text-black bg-white px-1 py-1 rounded-full"><i class="fa-brands fa-python"></i> PYTHON</p>
                        </div>
                    </div>
                    {/* Experience */}
                    <div className="mt-2 md:mt-3">
